...
def Bee_Colony_Algorithm():
    ...
    while(elapsed_limitation_time<cpu_time_limit):
        ...
        ABC = Artificial_Bee_Colony.ABC_algorithm(employed_bees_num, nK, nI, Capacity, Profits, Weights, onlooker_bees_num, max_improvement_try, pc, pm, k_tournomet_percent, percedure_type, p_setZero)
...
if __name__ == '__main__':    
    ...
    p_setZero = 0.05 # the probblity of making 1s to 0s in "make_feasible" function
    ...
    nK, nI, Capacity, Profits, Weights, real_answer = Reading_Data_petersen.Reading(data_file_name)
