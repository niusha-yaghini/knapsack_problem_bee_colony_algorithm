...
class Hybrid_Artificial_Bee_Colony:
    ...
    def __init__(self, index, run_id, category, problem_num, nK, nI, Capacity, Profits, Weights, cpu_time_limit, employed_bees_num, onlooker_bees_num, max_try_improve, crossover_type, pc_onePoint, pc_uniForm, crossover_neighbor_selection, cn_k_tournoment, pm, make_feasible_check, onlooker_selection, onlooker_k_tournoment, p_scout_delete, heuristic_phase_check, heuristic_iteration_num, heuristic_selection, h_k_tournoment, p_set_zero, result_file_name):
    ...
    def optimize(self):
        ...
        while(elapsed_time<self.cpu_time_limit):
            ...
            #     self.heuristic_phase(best_bee_of_iteration)
            ...
            if(best_fitness_of_iteration > best_fitness_so_far):
                ...
                if(self.heuristic_phase_check == 'yes'):
                    self.heuristic_phase(best_bee_so_far)
    ...
    def scout_bees_phase(self):
        ...
        limit_amount = self.p_scout_delete
        amount = 0
        index = 0
    ...
    def heuristic_phase(self, bee): 
        ...
        for iter in range(self.heuristic_iteration_num):
            ...
            if(new_bee.fitness>bee.fitness):
                ...
                bee.fitness = new_bee.fitness
                bee.try_improve = 0
                # change_best_flag = True
                print("   improvement by heuristic!")
                print("best fitness so far:", bee.fitness)

        # return change_best_flag
